    ...
    return (
        <section className="max-w-7xl mx-auto md:mt-4 " id={id}>
            ...
            <div className="px-4 -mt-26 md:-mt-32 lg:-mt-38 w-full flex flex-col items-start md:items-center ">
                ...
                <h1 className="my-3 text-3xl md:text-5xl font-semibold italic font-['Playfair_Display'] text-[var(--foreground)]">{personalInfo.name}</h1>
                <div className="flex items-center gap-2 md:text-lg text-[var(--muted-text)]">
